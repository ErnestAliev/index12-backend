...
async function generateConversationalResponse({
    ...
    const systemPrompt = [
        ...
        'Если вопрос общий (например, "как дела"), дай целостную картину: текущий статус, отклонения факт/план, риски, маржинальность, наблюдения.',
        'Если вопрос узкий, отвечай точечно по сути и добавляй только релевантные цифры.',
        'Факт = уже произошло; План = ожидается в будущем.',
        'Запрещено использовать пустые фразы без чисел и причинно-следственных связей.',
