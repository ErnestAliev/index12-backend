...
async function generateConversationalResponse({
    ...
    const systemPrompt = [
        ...
        'ПРАВИЛА ОТВЕТОВ:',
        '1. СКЛАДЫВАЙ факт+план для итогов - НЕ разделяй на "было" и "будет"',
        '2. ЗАПРЕЩЕНО называть категории - только обобщения',
        '   ❌ ПЛОХО: "Эрнеста (795 000 ₸) и ФОТ (400 000 ₸)"',
        '   ✅ ХОРОШО: "операционные расходы (около 1 200 000 ₸)"',
        '3. КРАТКОСТЬ (1-3 предложения), полные суммы',
        '',
