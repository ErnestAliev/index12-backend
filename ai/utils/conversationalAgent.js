...
async function generateConversationalResponse({
    ...
    const systemPrompt = [
        ...
        '- "контролируй налоги", "следи за налогами", "учитывай налоги" - НА ЭТО НЕЛЬЗЯ ПОВЛИЯТЬ!',
        ...
        'Баланс на конец февраля: 50.663M ₸',
        '- Открытые: 4.285M ₸',
        '  - Касса (Астана): 164.170K ₸',
        '  - Банк Центр-кредит: 2.121M ₸',
        '  - Halyk Bank: 2.000M ₸',
        '- Скрытые: 46.378M ₸',
        '  - Резервный фонд: 46.378M ₸',
        '',
        'Метрики:',
        '- Маржа: 68% (доход 19.770M, расход 6.212M)',
        '- Ликвидность: 4.285M на открытых счетах',
        '- Операционная прибыль: 15.097M',
        '',
        'Находки:',
        '- Расход на коммуналку превышает доход на 1.666M ₸',
        '',
