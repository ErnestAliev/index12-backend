      ...
      const systemPrompt = (() => {
        if (isDeep) {
          return [
            ...
            'Если просят "где теряю деньги" или "потери" — выдай ТОП-3 по сумме (категории/проекты/контрагенты): формат одной строкой "ТОП потери: 1) … ₸  2) … ₸  3) … ₸".',
            'После ТОП-3 предложи 1 действие (пример: "Разложить ФОТ по людям?" или "Показать коммуналку по объектам?").',
        ...
        return [
          ...
          'Если спрашивают "где теряю деньги"/"потери" — выдай ТОП-3 по сумме (категории/проекты/контрагенты) в формате "ТОП потери: 1) … ₸  2) … ₸  3) … ₸", без советов; затем предложи 1 действие (пример: "Разложить ФОТ по людям?").',
