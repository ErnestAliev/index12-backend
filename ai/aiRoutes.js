      ...
      const systemPrompt = (() => {
        if (isDeep) {
          return [
            ...
            'Режим: deep — дай развёрнутый, но компактный анализ (до 6–8 предложений), делай выводы и подсвети риски/интересные наблюдения.',
            'Опирайся только на данные, ничего не придумывай. Если чего-то нет — так и скажи.',
