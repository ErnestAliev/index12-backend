...
/**
 * * --- МЕТКА ВЕРСИИ: v14.1-CAT-ORDER-FIX ---
 * * ВЕРСИЯ: 14.1 - Исправление сортировки категорий
 * * ДАТА: 2025-11-23
 *
 * ЧТО ИЗМЕНЕНО:
 * 1. (SCHEMA) В categorySchema добавлено поле `order`. Теперь сортировка в редакторе будет сохраняться.
 */
...
// 🟢 ИСПРАВЛЕНИЕ ЗАДАЧА-1.1: Добавлено поле order для работы сортировки
